...
while True:      
    ...
    if "." in n1: 
       n1 = float(n1)
        ...
        n1 = str(n1)
    if (str(n1).isnumeric()) or (n1 in ["cos", "sin", "tg", "sqrt"]) or (isinstance(n1, float) or ('-')):
        if n1 in ["cos", "sin", "tg", "sqrt"]:
        ...
        elif (str(n1).isnumeric()) or (isinstance(n1, float) or ('-')):    
            ...
            if n2 == '': break
            while True:
                if (str(n2).isnumeric()) or (isinstance(n2, float) or ('-')):
                    break
                else:
                    print("Неверные данные, повторите ввод: ")
                    n2 = input()
